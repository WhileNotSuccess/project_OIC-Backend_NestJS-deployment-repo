...
export class TypeormPrideOfYjuRepository extends PrideOfYjuRepository{
    ...
    async getOne(id: number): Promise<PrideOfYju | null> {
        const orm=await this.dataSource.manager.findOneBy(PrideOfYjuOrmEntity,{id})
    ...
    async update(id: number, POY: Partial<PrideOfYju>): Promise<PrideOfYju | null> {
        ...
        await this.dataSource.manager.update(PrideOfYjuOrmEntity,{id},orm)
        return this.getOne(id)
    }
    async delete(id: number): Promise<boolean> {
        const result =await this.dataSource.manager.delete(PrideOfYjuOrmEntity,{id})
